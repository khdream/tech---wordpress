...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/contact-complete/style.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/contact-complete/smart-phone.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/contact-complete/tablet.css">
...
<body>
    <header id="header">
        ...
        <div class="login-top-text">
          <h1>CONTACT COMPLETE</h1>
          <h2 class="h2">お問い合わせ完了</h2>
          <div class="bread">
            <h2 onclick="location.href = '<?php echo home_url(); ?>'" style="cursor: pointer;">HOME</h2>
            <img src="<?php echo get_template_directory_uri();?>/assets/img/contact-complete/bread.svg" alt="" />
            <h2 onclick="location.href = '<?php echo home_url('contact'); ?>'" style="cursor: pointer;">お問い合わせ</h3>
            <img src="<?php echo get_template_directory_uri();?>/assets/img/contact-complete/bread.svg" alt="" />
            <h3>お問い合わせ完了</h3>
          </div>
        </div>
