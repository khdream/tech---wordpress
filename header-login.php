...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/login/style.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/login/smart-phone.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/login/tablet.css">
...
<body>
    <header id="header">
        ...
        <div class="login-top-text">
          <h1>USER LOGIN</h1>
          <h2 class="h2">ユーザー専用サポートページへのログイン</h2>
          <div class="bread">
            <h2 onclick="location.href = '<?php echo home_url(); ?>'" style="cursor: pointer;">HOME</h2>
            <img src="<?php echo get_template_directory_uri();?>/assets/img/login/bread.svg" alt="" />
            <h2 onclick="location.href = '<?php echo home_url('user-support'); ?>'" style="cursor: pointer;">ユーザーサポート</h3>
            <img src="<?php echo get_template_directory_uri();?>/assets/img/login/bread.svg" alt="" />
            <h3>ログイン</h3>
          </div>
        </div>
