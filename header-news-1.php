...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/news-1/style.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/news-1/smart-phone.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/news-1/tablet.css">
...
<body>
    <header id="header">
      ...
      <div class="login-top-text">
        ...
        <div class="bread">
          <h2>HOME</h2>
          <img src="<?php echo get_template_directory_uri();?>/assets/img/news-1/bread.svg" alt="" />
          <h3>ニュース</h3>
        </div>
      </div>
    </header>
