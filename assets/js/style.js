var isOpened = false;
function openNav(e) {
    document.getElementById("mySidenav").style.width = isOpened
        ? "0"
        : "100%";
    if (!isOpened) document.getElementById("burger").classList.add("active");
    else document.getElementById("burger").classList.remove("active");
...
window.addEventListener('scroll', function () {
    ...
    if (scrollPosition == maxScroll) {
        ...
        image.src = 'http://localhost/Logical-tech/wp-content/themes/LogicalTech/assets/img/img/logo.svg'; // スクロール量が一定範囲内の場合は最初の画像を表示
        ...
        image.src = 'http://localhost/Logical-tech/wp-content/themes/LogicalTech/assets/img/img/logo2.svg'; // スクロール量が一定範囲を超えた場合は別の画像を表示
        for (var i = 0; i < links.length; i++) {
