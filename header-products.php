...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/products/style.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/products/smart-phone.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/products/tablet.css">
    ...
    <header id="header">
      ...
      <div class="login-top-text">
        ...
        <div class="bread">
          ...
          <img src="<?php echo get_template_directory_uri();?>/assets/img/products/bread.svg" alt="" />
          <h3>製品一覧</h3>
        </div>
      </div>
    </header>