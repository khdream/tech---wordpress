...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/contact/smart-phone.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/contact/tablet.css">
    ...
    <header id="header">
      ...
      <div class="login-top-text">
        ...
        <div class="bread">
          ...
          <img src="<?php echo get_template_directory_uri();?>/assets/img/contact/bread.svg" alt="" />
          <h3>お問い合わせ</h3>
        </div>
      </div>
    </header>
