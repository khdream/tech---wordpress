...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/support-info/style.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/support-info/smart-phone.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/support-info/tablet.css">
    ...
    <header id="header">
        <nav>
          ...
          <div class="login-top-text">
            <h1>SUPPORT INFO</h1>
            <h2 class="h2">サポートインフォ</h2>
            <div class="bread">
                <h2 onclick="location.href = '<?php echo home_url(); ?>'" style="cursor: pointer;">HOME</h2>
                <img src="<?php echo get_template_directory_uri();?>/assets/img/support-info/bread.svg" alt="" />
                <h2 onclick="location.href = '<?php echo home_url('user-support'); ?>'" style="cursor: pointer;">ユーザーサポート</h2>
                <img src="<?php echo get_template_directory_uri();?>/assets/img/support-info/bread.svg" alt="" />
                <h3>サポートインフォ</h3>
            </div>
          </div>
