...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/user-support/style.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/user-support/smart-phone.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/user-support/tablet.css">
    ...
    <header id="header">
      ...
      <div class="login-top-text">
        ...
        <div class="bread">
          ...
          <img src="<?php echo get_template_directory_uri();?>/assets/img/user-support/bread.svg" alt="" />
          <h3>ユーザーサポート</h3>
        </div>
      </div>
    </header>
