...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/lock-star/style.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/lock-star/smart-phone.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/lock-star/tablet.css">
    <?php wp_head(); ?>
</head>
...
<body>
    <header id="header">
      ...
      <div class="login-top-text">
        ...
        <h1>LOCK STAR - SGate</h1>
        <h2 class="h2">情報漏洩を防止できるSSL-VPNリモートアクセス製品</h2>
        <div class="bread">
          <h2 onclick="location.href = '<?php echo home_url(); ?>'" style="cursor: pointer;">HOME</h2>
          <img src="<?php echo get_template_directory_uri();?>/assets/img/lock-star/bread.svg" alt="" />
          <h3>ユーザーサポート</h3>
        </div>
      </div>
    </header>