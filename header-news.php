...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/news/style.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/news/smart-phone.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/assets/css/news/tablet.css">
    ...
    <header id="header">
      ...
      <div class="login-top-text">
        ...
        <div class="bread">
          ...
          <img src="<?php echo get_template_directory_uri();?>/assets/img/news/bread.svg" alt="" />
          <h2 onclick="location.href = '<?php echo home_url('news-1'); ?>'" style="cursor: pointer;">ニュース</h2>
          <img src="<?php echo get_template_directory_uri();?>/assets/img/news/bread.svg" alt="" />
          <h3>こちらにニュースタイトルが入り...</h3>
        </div>
      </div>
    </header>
